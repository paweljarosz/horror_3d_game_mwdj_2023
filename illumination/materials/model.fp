...
vec3 get_specular_color(vec3 map_specular, float light_specular, vec3 light_color, vec3 light_direction, vec3 surface_normal, vec3 view_direction) {
    ...
    float surface_shininess = surface.x;//0.10240;//0.10000;// * map_specular.x;
...
void main() {
    ...
    // Specular is get from Roughness which is somehow negative of Specular
    specular_map_color.x = 1 - specular_map_color.x;
    specular_map_color.y = 1 - specular_map_color.y;
    specular_map_color.z = 1 - specular_map_color.z;
